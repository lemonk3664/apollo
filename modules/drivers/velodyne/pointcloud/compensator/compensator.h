...
class Compensator {
 public:
  Compensator(ros::NodeHandle node, const VelodyneConf& velodyne_conf);
  virtual ~Compensator() {}
  ...
  * compensator
  */
  sensor_msgs::PointCloud2::Ptr pointcloud_callback(const sensor_msgs::PointCloud2ConstPtr& msg);
  /**
